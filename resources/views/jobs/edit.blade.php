<x-layout>
  ...
  <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
    ...
    @method('PUT')
        ...
        <x-inputs.text-area id="benefits" name="benefits" label="Benefits" placeholder="Bachelor's degree in Computer Science" :value="old('benefits', $job->benefits)" />  

        <x-inputs.text id="tags" name="tags" label="Tags (comma-separated)" placeholder="Health insurance, 401k, paid time off" :value="old('tags', $job->tags)" />
